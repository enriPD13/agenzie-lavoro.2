      ...
      <div class="bg-white rounded-3xl overflow-hidden shadow-sm">
        ...
        <div class="p-5">
          <div class="flex items-start justify-between mb-2">
            ...
            <button onclick="Enti.toggleFavorite(${e.id})" class="ml-2 w-10 h-10 rounded-full flex items-center justify-center ${favClass}">
          ...
          ${e.sede_principale ? `<div class="text-sm text-gray-600 mb-2">📍 ${e.sede_principale}</div>` : ''}
          
          <div class="flex gap-2 mb-3">
            <span class="bg-purple-50 text-purple-700 px-3 py-1 rounded-full text-xs font-semibold">${e.provincia_sigla}</span>
            <span class="text-xs text-gray-500">${e.citta}</span>
          </div>
