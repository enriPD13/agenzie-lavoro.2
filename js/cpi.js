      ...
      <div class="bg-white rounded-3xl overflow-hidden shadow-sm">
        ...
        <div class="p-5">
          <div class="flex items-start justify-between mb-2">
            ...
            <button onclick="CPI.toggleFavorite('${p.sigla}')" class="ml-2 w-10 h-10 rounded-full flex items-center justify-center ${isFav ? 'bg-yellow-100' : 'bg-gray-100'}">
              <svg class="w-6 h-6 ${isFav ? 'text-yellow-500' : 'text-gray-400'}" fill="${isFav ? 'currentColor' : 'none'}" stroke="currentColor" viewBox="0 0 24 24">
    ...
    return `
      <div class="bg-gray-50 rounded-2xl p-4 mb-4">
        <div class="flex items-start justify-between mb-2">
          ...
          <button onclick="CPI.toggleSedeFavorite('${sedeId}', '${provinciaNome}', '${s.citta}')" class="w-8 h-8 rounded-full flex items-center justify-center ${isFav ? 'bg-yellow-100' : 'bg-gray-100'}">
