      ...
      <div class="bg-white rounded-3xl overflow-hidden shadow-sm">
        ...
        <div class="p-5">
          <div class="flex items-start justify-between mb-2">
            ...
            <button onclick="CPI.toggleFavorite(&quot;${p.sigla}&quot;)" class="ml-2 w-10 h-10 rounded-full flex items-center justify-center ${favClass}">
    ...
    return `
      <div class="bg-gray-50 rounded-2xl p-4 mb-4">
        <div class="flex items-start justify-between mb-2">
          ...
          <button onclick="CPI.toggleSedeFavorite(&quot;${sedeId}&quot;, &quot;${provinciaNome}&quot;, &quot;${s.citta}&quot;)" class="w-8 h-8 rounded-full flex items-center justify-center ${favClass}">
            <svg class="w-5 h-5 ${starColor}" fill="${starFill}" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
            </svg>
          </button>
        </div>
